...
The fix uses __prefill_sheaf_pfmemalloc() as a point to refill from node barn's full and partial, and if it fails continue with the current refilling process and return 0 otherwise.
